...
image_dir = 'D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/save_images/image_with_trans_line/new_data_set/lbp'
mask_dir = 'D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/save_images/image_with_trans_line/new_data_set/lbp/masks'
...
df_data = df.iloc[1:]
# # Filter rows
df_data = df_data[~((df_data['Label'] == 0) & (df_data.drop('Label', axis=1) > 50).any(axis=1))]
# df_data = df_data[~((df_data['Label'] == 1) & (df_data.drop('Label', axis=1) > 0).any(axis=1))]
final_df = df_data[~((df_data['Label'] == 1) & (df_data.iloc[:, 0:2] < 50).any(axis=1))]
...
save_path = 'D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/annotated two regions/features_17_stat_lbp.csv'
