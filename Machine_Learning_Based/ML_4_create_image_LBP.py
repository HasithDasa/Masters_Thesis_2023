...
def plot_image_and_save(img, pos, pos_from_trailing, title="Image and Transition"):
    ...
    file_path = "D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/save_images/image_with_trans_line/new_data_set/lbp/trans_details.xlsx"
    ...
    output_dir_files = "D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/save_images/image_with_trans_line/new_data_set/lbp/validation"
    output_dir_masks = "D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/save_images/image_with_trans_line/new_data_set/lbp/masks"
    ...
    lbp_image = local_binary_pattern(cropped_img, P=80, R=10, method="uniform")

    np.save(output_dir_file_name_npy, lbp_image)
