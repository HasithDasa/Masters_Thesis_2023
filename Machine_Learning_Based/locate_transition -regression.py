...
from preprocessing import preprocess, plot_np_image, find_edges, assign_edges, remove_dead_on_blade, plot_np_image_with_edges, add_noise, save_image
...
def plot_image_and_save(img, pos, pos_from_trailing, title="Image and Transition"):
    ...
    # Append the new data
    df_data_save = df_data_save.append({'image name': file_name, 'transitional_line': value, 'trailing_edge':trailing_edge_pos}, ignore_index=True)

    # Save the DataFrame to the Excel file
    df_data_save.to_excel(file_path, index=False)

    output_dir_files ="D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/save_images/image_with_trans_line/new_data_set/"
    output_dir_masks = "D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/save_images/image_with_trans_line/new_data_set/masks/"
