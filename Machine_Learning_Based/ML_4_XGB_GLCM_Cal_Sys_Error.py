...
data_dir = 'D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/annotated two regions/dataset 4/glcm/systematic_error/XGB/patch_5'
model_save_dir = data_dir
excel_file_path = 'D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/annotated two regions/dataset 4/glcm/systematic_error/XGB/patch_5/results.xlsx'
...
for file in os.listdir(data_dir):
    if file.endswith('.csv'):
        ...
        for features in feature_combinations:
            ...
            # Save the best GBM model for each feature combination
            model_filename = f'{file[:-4]}_xgb.joblib'
            path_and_name = os.path.join(model_save_dir, model_filename)
            joblib.dump(best_xgb_clf, path_and_name)
