...
def load_dataset(image_dir, mask_dir, target_size=(64, 64)):
    ...
    image_dir_valida = image_dir + '/validation'
...
if __name__ == "__main__":
    ...
    image_dir = "D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/save_images/image_with_trans_line/new_data_set/230920_164712/Unet/normalized"
    ...
    image_dir_valida = image_dir + '/validation'
    excel_file = "/trans_details_Unet.xlsx"
