...
# img = np.load('D:/Academic/MSc/Thesis/Project files/Project Complete/data/Old data/1520.npy')

img = np.load('D:/Academic/MSc/Thesis/Project files/Project Complete/data/new data/save_images/image_with_trans_line/irdata_0001_0002.npy')
...
lbp_image = local_binary_pattern(img_copy, 1000, 1, method='uniform')

lbp_image[lbp_image <= 750] = 0
lbp_image[lbp_image > 750] = 1


np.save('lbptest.npy', lbp_image)
print(np.unique(lbp_image))

cv2.imshow('lbp_image img', lbp_image)
...
# data = lbp_image.astype(int) # Replace with your .npy file path
